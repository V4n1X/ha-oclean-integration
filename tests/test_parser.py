...
# CPython changed the datetime ValueError text for an invalid day in 3.14
# (<=3.13: "day is out of range for month"; >=3.14: "day 0 must be in range 1..31
# for month 1 in year 2024"), so match both spellings.
_DAY_RANGE_RE = r"(day is out of range|day \d+ must be in range)"
...
class TestDeviceDatetime:
    ...
    def test_day_zero_raises(self):
        with pytest.raises(ValueError, match=_DAY_RANGE_RE):
